...
export const dictionaries = {
  en: {
    ...
    loyalty: {
      ...
      howItWorks: "Only drinks earn stamps. After 10 paid drinks, the lowest-priced eligible drink in your next order is automatically free. Refunded drinks lose their stamps.",
  ...
  de: {
    ...
    loyalty: {
      ...
      howItWorks: "Nur Getränke sammeln Stempel. Nach 10 bezahlten Getränken ist das günstigste teilnehmende Getränk der nächsten Bestellung automatisch gratis. Bei einer Erstattung werden die Stempel abgezogen.",
